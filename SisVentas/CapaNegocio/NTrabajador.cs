...
namespace CapaNegocio
{
    ...
    {//Métodos para comunicarnos con la capa datos
        ...
        //de la CapaDatos
        public static string Editar(int cod_trabajador, string nombre, string apellidos,
            string genero,
            DateTime fecha_nacimiento, string num_documento,
        ...
        //de la CapaDatos
        public static string Eliminar(int cod_trabajador)
        {
            DTrabajador Obj = new DTrabajador();
            Obj.Cod_trabajador = cod_trabajador;
        ...
        //Método BuscarNum_Documento que llama al método Login
        //de la clase DTRabajador de la CapaDatos
