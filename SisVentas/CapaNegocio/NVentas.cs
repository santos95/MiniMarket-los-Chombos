...
namespace CapaNegocio
{
    ...
    {
        public static string Insertar(int cod_cliente, int cod_trabajador, DateTime fecha,
              ...
              DataTable dtDetalles)
        {
            ...
            foreach (DataRow row in dtDetalles.Rows)
            {
                ...
                detalle.Cod_detalle_ingreso = Convert.ToInt32(row["cod_detalle_ingreso"].ToString());
        ...
        public static string Eliminar(int cod_venta)
        {
            DVenta Obj = new DVenta();
            Obj.Cod_venta = cod_venta;
