...
namespace CapaDatos
{
    public class DTrabajador
    {
        ...
        public DTrabajador(int cod_trabajador, string nombre, string apellidos, string genero,
            DateTime fecha_nacimiento, string num_documento, string direccion, string telefono, string email, string acceso, string usuario, string password, string textobuscar)
        {
        ...
        public string Insertar(DTrabajador Trabajador)
        {
            ...
            try
            {
                ...
                ParCod_trabajador.Direction = ParameterDirection.Output;
                ...
                rpta = SqlCmd.ExecuteNonQuery() == 1 ? "OK" : "N se ingreso el registro";
