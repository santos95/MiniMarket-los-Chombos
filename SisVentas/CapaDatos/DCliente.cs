...
namespace CapaDatos
{
   public  class DCliente
    {  //Variables
        ...
        public DCliente(int cod_cliente, string nombre, string apellidos, string genero, DateTime fecha_nacimiento, string tipo_documento, string num_documento, string direccion, string telefono, string email, string textobuscar)
        {
        ...
        public string Insertar(DCliente Cliente)
        {
            ...
            try
            {
                ...
                ParCod_cliente.Direction = ParameterDirection.Output;
