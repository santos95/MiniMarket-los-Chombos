...
namespace CapaPresentacion
{
    public partial class FrmVenta : Form
    {
        ...
        public void setCliente(string cod_cliente, string nombre)
        {
            this.txtCod_cliente.Text = cod_cliente;
            this.txtCliente.Text = nombre;
        }

        public void setArticulo(string cod_detalle_ingreso, string nombre,
            decimal precio_compra, decimal precio_venta, int stock,
            DateTime fecha_vencimiento)
        {
            this.txtCod_articulo.Text = cod_detalle_ingreso;
        ...
        {
            this.txtCod_venta.Text = string.Empty;
            this.txtCod_cliente.Text = string.Empty;
        ...
        {
            this.txtCod_venta.ReadOnly = !valor;
        ...
        private void crearTabla()
        {
            ...
            this.dtDetalle.Columns.Add("cod_detalle_ingreso", System.Type.GetType("System.Int32"));
        ...
        {
            this.txtCod_venta.Text = Convert.ToString(this.dataListado.CurrentRow.Cells["cod_venta"].Value);
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (this.txtCod_articulo.Text == string.Empty || this.txtCantidad.Text == string.Empty
                ...
                else
                {
                    ...
                    {
                        if (Convert.ToInt32(row["cod_detalle_ingreso"]) == Convert.ToInt32(this.txtCod_articulo.Text))
                        {
                            registrar = false;
                    ...
                    if (registrar && Convert.ToInt32(txtCantidad.Text) <= Convert.ToInt32(txtStock_Actual.Text))
                    {
                        ...
                        row["cod_detalle_ingreso"] = Convert.ToInt32(this.txtCod_articulo.Text);
        ...
        private void lblTotal_Pagado_Click(object sender, EventArgs e)
        {
        ...
        {
            if (txtPrecio_Compra.Text != "" || txtPrecio_Venta.Text != ""|| txtCantidad.Text !="" || txtStock_Actual.Text !="")
            {
