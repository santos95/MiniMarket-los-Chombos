...
namespace CapaPresentacion
{
    public partial class FrmVistaProveedor_Ingreso : Form
    {
        ...
        private void dataListado_DoubleClick(object sender, EventArgs e)
        {
            ...
            string par1, par2;
            par1 = Convert.ToString(this.dataListado.CurrentRow.Cells["cod_proveedor"].Value);
            par2 = Convert.ToString(this.dataListado.CurrentRow.Cells["razonsocial_nombre"].Value);
