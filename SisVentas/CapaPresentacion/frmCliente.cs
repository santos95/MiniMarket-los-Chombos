...
namespace CapaPresentacion
{
    public partial class frmCliente : Form
    {
        ...
        private void Habilitar(bool valor)
        {
            ...
            this.txtCod_cliente.ReadOnly = !valor;
        }
       ...
       */
        ...
        {
            this.txtCod_cliente.Text = Convert.ToString(this.dataListado.CurrentRow.Cells["cod_cliente"].Value);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (!this.txtCod_cliente.Text.Equals(""))
            {
                this.IsEditar = true;
                this.Botones();
                this.Habilitar(true);
        ...
        {
            if (txtNombre.Text != "" || txtApellidos.Text != "" || txtDireccion.Text != "" || txtNum_Documento.Text != "")
            {
